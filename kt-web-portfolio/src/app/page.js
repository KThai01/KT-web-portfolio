    ...
    <div>
      ...
      <main>
        ...
        <section className="min-h-screen bg-gray-800">
          <h3 className="text-4xl text-emerald-600 justif-center font-bold px-10 py-10 font-sans">Skills</h3>
        ...
        <section className="min-h-screen bg-gray-800">
        <h3 className="text-4xl text-emerald-600 justif-center font-bold px-10 py-10 font-sans">Projects</h3>
        </section>
